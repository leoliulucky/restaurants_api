...
import com.benxiaopao.provider.dao.model.UserRegisterTempExample.Criteria;
import com.benxiaopao.provider.dao.model.UserRegisterTempExample.Criterion;
...
public class UserRegisterTempSqlProvider {
    ...
    public String countByExample(UserRegisterTempExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("user_register_temp");
    ...
    public String deleteByExample(UserRegisterTempExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("user_register_temp");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(UserRegisterTemp record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("user_register_temp");
        ...
        if (record.getTempInfo() != null) {
            sql.VALUES("tempInfo", "#{tempInfo,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getTempInfo() != null) {
            sql.SET("tempInfo = #{record.tempInfo,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(UserRegisterTemp record) {
        ...
        if (record.getTempInfo() != null) {
            sql.SET("tempInfo = #{tempInfo,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated Sat Apr 20 10:26:22 CST 2019
     */
    protected void applyWhere(SQL sql, UserRegisterTempExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
